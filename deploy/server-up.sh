...
REVOKE UPDATE, DELETE ON budget_revision, hometax_submission, hometax_item, hometax_result, offering_type, offering_reversal, offering_event, donation_receipt, donation_receipt_item, receipt_cancellation, audit_event, member_status_history, attendance_change, newcomer_change, care_change, finance_account, finance_fund, expense_submission, expense_submission_attachment, expense_event, expense_payment, journal_entry, journal_line FROM church_runtime;
