...
REVOKE UPDATE, DELETE ON audit_event, member_status_history FROM church_runtime;
REVOKE DELETE ON household_membership, organization_membership, position_appointment, member_relation FROM church_runtime;
SQL
